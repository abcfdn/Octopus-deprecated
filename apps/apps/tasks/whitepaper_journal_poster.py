...
class WhitepaperJournalPoster(Task):
    ...
    def draw_text(self, img, text, settings):
        ...
        img.get_font(self.font_dir, settings['font'])
    ...
    def add_topic(self, events):
        ...
        topic_img = get_template_img('topic.png')
    ...
    def create_event(self, event):
        ...
        event_img = get_template_img('item.png')
    ...
    def save(self, composer, upload=True):
        if not filename:
